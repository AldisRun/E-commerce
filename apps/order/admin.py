...
def admin_order_shipped(modeladmin, request, queryset):
    for order in queryset:
        ...
        send_mail('Order sent', 'Your order is successful!', 'noreply@mygadgets.com', ['mail@mygadgets.com', order.email], fail_silently=False, html_message=html)
    return
...
class OrderAdmin(admin.ModelAdmin):
    ...
    search_fields = ('first_name', 'last_name', 'address', 'place')
